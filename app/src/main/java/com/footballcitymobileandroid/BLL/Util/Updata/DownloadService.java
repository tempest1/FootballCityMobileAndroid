...
public class DownloadService extends IntentService {
	// 10-10 19:14:32.618: D/PictureDownload(1926): 测试缓存：41234 32kb
	// 10-10 19:16:10.892: D/PictureDownload(2069): 测试缓存：41170 1kb
	// 10-10 19:18:21.352: D/PictureDownload(2253): 测试缓存：39899 10kb
	private static final int BUFFER_SIZE = 10 * 1024; // 8k ~ 32K
	private static final String TAG = "PictureDownload";
...
//		this.urls=urls;
	...
	protected void onHandleIntent(Intent intent) {
		...
		String urlStr = app.getUrl();//intent.getStringExtra(CheckVersion.APK_DOWNLOAD_URL);
		InputStream in=null;
...
//			File dir = StorageUtils.getCacheDirectory(this);	//在缓存中创建文件对象
			/**
			 * 自定义路径
			 */
			File dir = FileUtils.createNewFile(getApplicationContext(), Params.DOWN_LOAD);//
			Log.e("dir",dir.getPath());
			String apkName=urlStr.substring(urlStr.lastIndexOf("/")+1, urlStr.length());// 获取地址中的apkName
