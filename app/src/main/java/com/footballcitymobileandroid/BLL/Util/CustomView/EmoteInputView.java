...
import com.footballcitymobileandroid.BLL.Adapter.ClubAdapter.EmoteAdapter;
...
public class EmoteInputView extends LinearLayout implements OnClickListener,
	...
	public void init() {
		...
		mDefaultAdapter = new EmoteAdapter(getContext(),
				MainApplication.mEmoticons_Zem);
		mEmojiAdapter = new EmoteAdapter(getContext(),
				MainApplication.mEmoticons_Zemoji);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (mIsSelectedDefault) {
			text = MainApplication.mEmoticons_Zem.get(arg2);
		} else {
			text = MainApplication.mEmoticons_Zemoji.get(arg2);
		}
