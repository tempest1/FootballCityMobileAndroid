 ...
 */
public class ChallengeMatchSignNumberAdapter extends BaseAdapter {
    private List<AranaMatchMembs> listinfo;
    private android.content.Context context;
    // 填充数据的list
    ChallengeMatchSignNumberAdapter()
    {}
    // 用来控制CheckBox的选中状况
    private static HashMap<Integer, Boolean> isSelected;
    public ChallengeMatchSignNumberAdapter(android.content.Context context,List<AranaMatchMembs> listinfo)
    {
    ...
    public View getView(final int i, View convertView, ViewGroup parent) {
        ...
        AranaMatchMembs record=new AranaMatchMembs();
        record=listinfo.get(i);
        holder.name .setText(record.getPlayerName());
...
//        }
        ...
        if (record.getPlayerPhoto() != null) {
            bitmap= bitmapwithbyte.Bytes2Bimap(bytewithString.hexStringToBytes(record.getPlayerPhoto()));
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        ChallengeMatchSignNumberAdapter.isSelected = isSelected;
    }
