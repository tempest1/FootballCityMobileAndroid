...
import com.footballcitymobileandroid.openimui.common.SimpleWebViewActivity;
import com.footballcitymobileandroid.openimui.sample.DemoSimpleKVStore;
...
import com.footballcitymobileandroid.openimui.test.MultiAccountTestActivity;
    ...
    public void logout() {
        ...
        mLoginService.logout(new IWxCallback() {
            ...
            public void onSuccess(Object... arg0) {
                Toast.makeText(MainApplication.getContext(), "退出成功", Toast.LENGTH_SHORT).show();
                YWLog.i(TAG, "退出成功");
