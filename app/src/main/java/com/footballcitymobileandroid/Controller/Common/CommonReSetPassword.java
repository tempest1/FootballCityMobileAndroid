 ...
 */
public class CommonReSetPassword extends BaseCommonActivity implements View.OnClickListener, ActionCallBackListener<BaseEntity<userInfo>> {
    ...
    private void doit() {
        if (editText1.getText().toString().equals(editText2.getText().toString())) {
            ...
            appAction.fc_modifyPwd(editText2.getText().toString(), getcodes, Params.fc_modifyPwd, this);
        } else {
