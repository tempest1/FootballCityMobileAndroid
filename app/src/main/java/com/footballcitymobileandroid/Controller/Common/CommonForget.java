 ...
 */
public class CommonForget extends BaseCommonActivity implements View.OnClickListener, ActionCallBackListener<BaseEntity<userInfo>> {
    Intent intent;
    ...
    protected void initView() {
        ...
        detail_title_center.setText("忘记密码");
