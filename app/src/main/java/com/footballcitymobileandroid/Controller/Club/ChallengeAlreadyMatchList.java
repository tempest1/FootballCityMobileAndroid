 ...
 */
public class ChallengeAlreadyMatchList extends Activity implements View.OnClickListener,PullToRefreshLayout.OnRefreshListener{
    ...
    private void showInfoDetail(AranaMatchs data) {
        ...
        intent.setClass(this, ChallengeMatchSigns.class);
