...
import com.footballcitymobileandroid.BLL.Adapter.ClubAdapter.ChallengeEndMatchVoteAdapter;
 ...
 */
public class ChallengeEndVote  extends Activity implements  View.OnClickListener,PullToRefreshLayout.OnRefreshListener{
    TextView detail_title_center;
    Button detail_back,detail_title;
    ListView list;
    private List<String> data=new ArrayList<>();
    ChallengeEndMatchVoteAdapter adapter;
    ...
    private void init()
    {
        ...
        data.add("队员2");
        data.add("队员3");
        adapter=new ChallengeEndMatchVoteAdapter(this,data);
