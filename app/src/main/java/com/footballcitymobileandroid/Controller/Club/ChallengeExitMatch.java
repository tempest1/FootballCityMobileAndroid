 ...
 */
public class ChallengeExitMatch extends Activity  implements View.OnClickListener,PullToRefreshLayout.OnRefreshListener{
...
//        data= MatchInfo.InvestInfoDate();
        ...
        detail_title_center.setText("强制退赛比赛列表");
