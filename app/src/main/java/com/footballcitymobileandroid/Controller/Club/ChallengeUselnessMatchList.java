 ...
 */
public class ChallengeUselnessMatchList extends Activity implements View.OnClickListener,PullToRefreshLayout.OnRefreshListener{
...
//        data= MatchInfo.InvestInfoDate();
        ...
        detail_title_center.setText("已作废比赛列表");
...
//        intent.setClass(this, ChallengeAlreadyInfoDeal.class);
