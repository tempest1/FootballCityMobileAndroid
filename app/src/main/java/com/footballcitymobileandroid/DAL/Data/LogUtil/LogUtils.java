 ...
 * 日志工具类，会在sd卡上新建一个.log的文件
 */
public class LogUtils {

    public static String customTagPrefix = "smartLab"; // 自定义Tag的前缀，可以是作者名
    public static boolean isSaveLog = false; // 是否把保存日志到SD卡中
    public static String ROOT = Params.DATA_PATH ; // SD卡中的根目录
    ...
    public static void point(String path, String tag, String msg) {
        if (isSDAva()) {
            ...
            path += dateFormat.format(date) + ".log";//文件后缀名为.log
